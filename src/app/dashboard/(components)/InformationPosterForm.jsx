...
const handleCancel = () => {
  ...
  return (
    <form onSubmit={handleSubmit} className="flex flex-col gap-4 mt-8 items-center m-auto  w-full px-2">
        ...
        <div className="flex items-center justify-center w-full p-4">
          <Card className="relative p-2 w-full">
            ...
            <CardHeader>
              ...
              <CardDescription>The poster size 1920x1080p</CardDescription>
            </CardHeader>
            <CardContent className="space-y-4">
