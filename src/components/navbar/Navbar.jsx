...
const Navbar = () => {
  ...
  return (
    <nav
      className={`fixed top-0 z-50 w-full transition-all duration-300 whitespace-nowrap ${
    ...
    >
      <div className="w-full mx-auto flex items-center justify-between h-20 px-6 lg:px-16">
        ...
        {/* Desktop Links */}
        <div
          className={`hidden lg:flex items-center max-xl:gap-2 gap-6 uppercase font-semibold ${
